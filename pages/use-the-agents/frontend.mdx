---
title: Frontend (static) agent
description: How to use the frontend specialist — framework detection, S3 + CloudFront deploys, SSR on Fargate, cache policies, and troubleshooting.
diataxis: how-to
---
...
<Callout type="info">
  No Docker image is needed for pure static deployments. For SSR modes (Next.js, Nuxt 3 SSR, SvelteKit SSR), the agent generates a multi-stage Dockerfile and deploys to Fargate.
</Callout>
