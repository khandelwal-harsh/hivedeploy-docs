---
title: Qdrant agent
description: How to use the Qdrant specialist — vector cluster sizing, HNSW + quantization, hybrid search, snapshot backups, and recall monitoring.
diataxis: how-to
---
...
<Callout type="info">
  The Qdrant agent is in beta. It covers initial cluster deploy on EKS (AWS). GKE and AKS support, and managed Qdrant Cloud integration, are on the roadmap.
</Callout>
