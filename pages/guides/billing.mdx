...
fixed limits on seats, active agents, and monthly Claude API credits.
...
|---|---|---|---|---|
| **Free** | 2 | 1 | $5 in Claude API | $0 |
| **Team** | 5 | 3 | $70 in Claude API | $99 / mo |
| **Business** | 25 | 15 | $560 in Claude API | $499 / mo |
...
Every agent message that calls Claude API consumes credits at the
underlying Anthropic API rate (input + output tokens × Anthropic's
published pricing). Each plan includes a monthly Claude credit
budget:
...
the plan budget, additional usage is billed at the Anthropic
